...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
   <link rel="stylesheet" href="{{URL::asset('css/admin/_all-skins.min.css')}}">
  <!-- Morris chart -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>搜猫</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>搜猫</b>管理系统</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="https://soucat.cn">搜猫后台管理</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Morris.js charts -->
<script type="text/javascript" src="{{URL::asset('js/admin/raphael.min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('js/admin/morris.min.js')}}"></script>

<!-- Sparkline -->
<script type="text/javascript" src="{{URL::asset('js/admin/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
<script type="text/javascript" src="{{URL::asset('js/admin/jquery-jvectormap-1.2.2.min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('js/admin/jquery-jvectormap-world-mill-en.js')}}"></script>
<!-- daterangepicker -->
<script type="text/javascript" src="{{URL::asset('js/admin/moment.min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('js/admin/daterangepicker.js')}}"></script>

<!-- datepicker -->
<script type="text/javascript" src="{{URL::asset('js/admin/bootstrap-datepicker.min.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->

<script type="text/javascript" src="{{URL::asset('js/admin/bootstrap3-wysihtml5.all.min.js')}}"></script>
<!-- Slimscroll -->
